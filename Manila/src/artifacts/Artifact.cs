...
public class Artifact(Workspace workspace, ArtifactBuilder builder) {
    public readonly string Description = builder.ArtifactDescription;
    ...
    public readonly RegexUtils.PluginComponentMatch PluginComponent =
        builder.PluginComponent ?? throw new ManilaException($"Artifact must have a plugin component! {builder.Description}");
